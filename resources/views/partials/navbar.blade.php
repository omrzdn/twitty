<div class="topbar stick">
                            <div class="logo">
                                <a title="" href="{{Route('home')}}"><img src="{{ asset('assets/images/logo.png')}}" alt="" style="max-width:25%;"></a>
                            </div>
                            ...
                            <div class="top-area">
                                ...
                                <div class="user-img">
                                    ...
                                    <div class="user-setting">
                                        ...
                                        <a href="#" title="" onclick="event.preventDefault(); document.getElementById('logout-form').submit()"><i class="ti-power-off"></i>{{__('log out')}}</a>
                                    </div>
                                </div>
